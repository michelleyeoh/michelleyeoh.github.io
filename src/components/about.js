        ...
        <div className="about" id="about">
            ...
            <div className="container">
                <div className="half">
                    ...
                    <h6>I am a third-year at UC Davis with goals to pursue a career in software development. I am currently majoring in <strong>computer science</strong>, with a minor in <strong>technology management</strong>. </h6>
                    <h6>I have varying experiences in <strong>full-stack</strong> web development through opportunities on campus such as HackDavis, #include, and creating client websites. In addition, I have a creative background in graphic design and have explored <strong>UI/UX design</strong> in the past.</h6>
