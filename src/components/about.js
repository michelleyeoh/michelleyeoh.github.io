        ...
        <div className="about" id="about">
            ...
            <div className="container">
                <div className="half">
                    ...
                    <h6>I have several years of experience in full-stack web devlopment through various opportunities on campus such as HackDavis, #include, and creating websites for clubs. In addition, I have a creative background in graphic design and am also exploring <strong>UI/UX design</strong> for web and mobile devices.</h6>
