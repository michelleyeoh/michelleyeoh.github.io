...
import studypaws_landing from '../images/studypaws_landing.png'
// import studypaws_friends from '../images/studypaws_friends.png'
...
export default function Design(){
    return(
        <design className="design">
            ...
            <ProjectCard title={"Study Paws"} description={"3-Week Design Sprint"} time={"April -May 2024"} tool={"Figma"} img={studypaws_landing} linkTitle={"View Presentation →"}/>
            ...
            <ProjectCard title={"Video Editing"} description={"Personal Enjoyment"} time={"March 2018 - November 2021"} tool={"iMovie"} img={videos} linkTitle={"View Youtube →"}/>
        </design>
    )
}