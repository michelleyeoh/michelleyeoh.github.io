            ...
            <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }}>
                <div className="technical" id="technical">
                    ...
                    <div className="cardGroup">
                        <ProjectCard title={"HackDavis Admissions Portal"} description={"Apply, manage, & send hacker application decisions."} img={hd_admissions} linkUrl={"https://apply.hackdavis.io/"} />
            ...
            <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }}>
                <div className="design" id="design">
                    ...
                    <div className="cardGroup">
                        ...
                        <ProjectCard title={"Photo Journaling"} description={"Scrapbooking my treasured moments."} tool={"Pen, Paper, Stickers"} img={""} />
                    </div>
                </div>
            </motion.div>
        </technical>
